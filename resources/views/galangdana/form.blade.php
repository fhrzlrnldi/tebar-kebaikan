<x-modal size="modal-xl" data-backdrop="static" data-keyboard="false">
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="form-group">
          ...
          <select name="kategoris" id="kategoris" class="select2 form-control">
    ...
    <div class="form-group">
      <label for="note">Tulis ajakan singkat</label>
      ...
      <div class="col-lg-6">
          <div class="form-group">
              ...
              <div class="custom-control custom-radio">
                  <input type="radio" name="penerima" class="custom-control-input" id="saya" value="Saya Sendiri">
                  <label class="custom-control-label font-weight-normal" for="saya">Saya Sendiri</label>
              </div>
              <div class="custom-control custom-radio">
                  <input type="radio" name="penerima" class="custom-control-input" id="keluarga" value="Keluarga / Kerabat">
                  <label class="custom-control-label font-weight-normal" for="keluarga">Keluarga / Kerabat</label>
              </div>
              <div class="custom-control custom-radio">
                <input type="radio" name="penerima" class="custom-control-input" id="organisasi" value="Organisasi / Lembaga">
                <label class="custom-control-label font-weight-normal" for="organisasi">Organisasi / Lembaga</label>
              </div>
              <div class="custom-control custom-radio">
                <input type="radio" name="penerima" class="custom-control-input" id="lainnya" value="Lainnya">
    ...
    <x-slot name="footer">
      ...
      <button type="button" class="btn btn-secondary" onclick="submitForm(this.form)">Simpan</button>
    </x-slot>
</x-modal>